...
def main():
    df = pd.read_csv(
        'C:/Users/jtran_000/Google Drive/growth scalers/Sonoma linen/Sponsored Products Search term report.csv',
    ...
    for i, word1 in enumerate(words):
        ...
        if len(wn_word1) == 0:
            ...
            X1.append(solver.IntVar(0.0, len(wn_word1),
                                    word1))  # As input we want to change syset index to maximize similarity
