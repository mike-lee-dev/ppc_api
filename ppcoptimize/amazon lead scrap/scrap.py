    ...
    try:
        ...
        for filename in all_files:
            ...
            df = pd.read_csv(filename,
                             delimiter=",")  # , on_bad_lines='skip') #index_col=None, header=0, on_bad_lines='skip')
            li.append(df)
...
def change_to_us_location(driver, zipcode):
    try:
        ...
        continuebutton = driver.find_element(By.ID,
                                             'GLUXConfirmClose')  # '//*[@id=\"GLUXConfirmClose\"]'#'GLUXConfirmClose-announce'
